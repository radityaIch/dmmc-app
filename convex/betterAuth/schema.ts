...
export const tables = {
  user: defineTable({
    ...
    whatsappSub: v.optional(v.union(v.null(), v.string())),
    waGroupId: v.optional(v.union(v.null(), v.string())),
    waGroupName: v.optional(v.union(v.null(), v.string())),
    waGroupVerified: v.optional(v.union(v.null(), v.boolean())),
  })

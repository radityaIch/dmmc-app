      ...
      <div className="rounded-3xl border border-white/10 bg-white/5 p-6 ring-1 ring-white/10 sm:p-8">
        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border border-white/10 bg-black/20 p-5 ring-1 ring-white/10">
            <div className="text-xs font-bold tracking-widest text-white/60">DRAG THIS</div>
            <div className="mt-3">
              <a
                href="#"
                ref={dragLinkRef}
            ...
            <p className="mt-3 text-sm leading-6 text-white/70">
              On desktop: drag this button to your bookmarks bar.
              <br />
              On mobile: use copy below and create a bookmark manually.
            </p>
          </div>

          <div className="rounded-2xl border border-white/10 bg-black/20 p-5 ring-1 ring-white/10">
            <div className="text-xs font-bold tracking-widest text-white/60">COPY LINK</div>
            <textarea
              readOnly

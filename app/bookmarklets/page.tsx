      ...
      <PageCard color="blue">
        <div className="mb-4 flex justify-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-cyan-300/40 bg-[#22d3ee]/10 px-4 py-2 text-xs font-semibold tracking-wider text-slate-500">
            <span className="h-2 w-2 rounded-full bg-[#22d3ee] shadow-[0_0_16px_rgba(34,211,238,0.55)]" />
            BOOKMARKLETS
          </div>
        </div>
        ...
        <p className="mb-8 text-center text-sm font-medium leading-6 text-slate-500 max-w-3xl mx-auto">
          ...
          <span className="font-semibold text-slate-700">/my-score</span> with the results.
        </p>

        <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="rounded-2xl border border-slate-100 bg-white/60 p-5">
            <div className="text-xs font-bold tracking-widest text-slate-400">PC Desktop / Laptop</div>
            <div className="mt-3">
              <a
                href="#"
                ref={dragMobileLinkRef}
                className="inline-flex w-full items-center justify-center rounded-full bg-gradient-to-b from-cyan-400 to-sky-600 px-6 py-3 text-sm font-semibold text-black shadow-[0_0_0_1px_rgba(34,211,238,0.55),0_0_24px_rgba(34,211,238,0.25)] hover:shadow-[0_0_0_1px_rgba(34,211,238,0.75),0_0_34px_rgba(34,211,238,0.45)]"
          ...
          <div className="rounded-2xl border border-slate-100 bg-white/60 p-5">
            <div className="text-xs font-bold tracking-widest text-slate-400">COPY (MOBILE)</div>
            <textarea
              readOnly
              value={mobileBookmarkletHref}
              className="mt-4 h-40 w-full resize-none rounded-2xl border border-slate-200 bg-[#17061f] p-4 font-mono text-xs text-white/80 outline-none"
            />
            <button
              type="button"
              onClick={async () => {
              ...
              className="mt-4 w-full rounded-full border border-slate-200 bg-slate-100 px-6 py-3 text-sm font-semibold text-slate-500 hover:bg-slate-200/50 hover:text-slate-700"
            >
